		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item active"><a class="nav-link" href="#">写影评<span
				...
				<form class="form-inline my-2 my-lg-0">
					...
					<ul class="navbar-nav">
						<li class="nav-item dropdown" id="user-drop"><a
							class="nav-link dropdown-toggle" href="userInfo"
	...
	<div id="content" style="background-color: white;">
		...
		<a href="#" id="movie-summary-card " target="_blank">
			<div class="media">
				...
				<div class="media-left">
					<img class="media-object" src="${movie.img }"
						alt="${movie.mname }图片" style="width: 5rem">
				</div>
				<div class="media-body">
					<h4 class="media-heading">
						<a href="movieDeatil?mid=${movie.mid }" id="sm-title">${movie.mname }</a>
					</h4>

					<p class="movie-summary">导演 ${movie.mdirect} / 主演
						${movie.mactor } ${movie.mcountry } / ${movie.mscore }分
						(${movie.mcount }评价)</p>
				</div>
				<!-- </a> -->
			</div>
		...
		<div class="card">
			<div class="card-header">
				<h4>
					<img src="../img/open-iconic-master/star-3x.png" alt="">
					给个评价吧
				</h4>
			</div>
			<div class="card-body">
			...
			<div id="write-Review">
				<form action="">
					<div id="review-heading">
						<label title="stitle">标题</label> <input type="text" id="head"
							name="stitle">
					</div>
